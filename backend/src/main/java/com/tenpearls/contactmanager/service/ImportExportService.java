...
public interface ImportExportService {
     ...
     */
    List<Contact> importCsv(MultipartFile file, User user) throws Exception;
     ...
     */
    byte[] exportCsv(List<Contact> contacts) throws Exception;
     ...
     * @throws Exception if parsing or persistence fails
     */
    List<Contact> importVcf(MultipartFile file, User user) throws Exception;
     ...
     * @throws Exception if writing fails
     */
    byte[] exportVcf(List<Contact> contacts) throws Exception;
}
